...
enum UnpatchedGlobal : ParamType {
	...
	UNPATCHED_TEMPO,
	// Clouds. Appended at the end rather than grouped with the other FX params:
	...
	// parameter. AUX Sends was reverted on this line, so its CV masters are gone and Clouds
	// lands directly after UNPATCHED_TEMPO. New global params go on the end, always.
