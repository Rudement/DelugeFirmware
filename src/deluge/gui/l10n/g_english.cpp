...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_LOW_MID, "Low mid"},
        {STRING_FOR_LOW_MID_FREQUENCY, "Low mid freq"},
        {STRING_FOR_LOW_MID_FREQUENCY_SHORT, "LMfq"},
        {STRING_FOR_HIGH_MID, "High mid"},
        {STRING_FOR_HIGH_MID_FREQUENCY, "High mid freq"},
        {STRING_FOR_HIGH_MID_FREQUENCY_SHORT, "HMfq"},
        ...
        {STRING_FOR_SEAR, "Sear"},
        {STRING_FOR_SEAR_TONE, "STon"},
        {STRING_FOR_BIAS, "Bias"},
        {STRING_FOR_DIRT, "Dirt"},
        {STRING_FOR_LEVEL, "Level"},
        {STRING_FOR_GRISTLE, "Gristleator"},
        ...
        {STRING_FOR_GRISTLE_DIRT, "Gristle dirt"},
        ...
        {STRING_FOR_DX7, "DX7"},
        {STRING_FOR_PLAITS, "BOULS"},
        {STRING_FOR_PLAITS_ENGINE, "Bouls model"},
        {STRING_FOR_PLAITS_HARMONICS, "Harmonics"},
        {STRING_FOR_PLAITS_TIMBRE, "Timbre"},
        {STRING_FOR_PLAITS_MORPH, "Morph"},
        {STRING_FOR_PLAITS_LPG, "Low-pass gate"},
        {STRING_FOR_PLAITS_DECAY, "LPG decay"},
        {STRING_FOR_PLAITS_LPG_COLOUR, "LPG colour"},
        {STRING_FOR_PLAITS_AUX, "Aux output"},
        ...
        {STRING_FOR_COMMUNITY_FEATURE_RETROSPECTIVE_CAPTURE, "Retrospective Capture"},
        {STRING_FOR_CHORD_BRUSH_ARMED, "Chord armed"},
        {STRING_FOR_CHORD_BRUSH_PLACED, "Chord placed"},
        {STRING_FOR_CHORD_BRUSH_CLEARED, "Chord cleared"},
        ...
        {STRING_FOR_COMMUNITY_FEATURE_KIT_SPLIT, "Kit Split"},
        {STRING_FOR_COMMUNITY_FEATURE_FOUR_BAND_EQ, "Four-Band EQ"},
        {STRING_FOR_COMMUNITY_FEATURE_PLAITS, "Bouls Engine"},
        {STRING_FOR_COMMUNITY_FEATURE_CLOUDS, "Wisps FX"},
        {STRING_FOR_COMMUNITY_FEATURE_GRISTLEIZER, "Gristleator"},
        {STRING_FOR_COMMUNITY_FEATURE_SEAR, "Sear"},
        ...
        {STRING_FOR_AUX_STAT_YIELDS, "Bus yields"},
        {STRING_FOR_AUX_STAT_TAKEBACKS, "Bus take backs"},
        {STRING_FOR_AUX_STAT_WRITTEN, "Windows written"},
        {STRING_FOR_AUX_STAT_DROPPED, "Windows dropped"},
        {STRING_FOR_AUX_STAT_RESYNCS, "Resyncs"},
        {STRING_FOR_AUX_STAT_STALLS, "DMA stalls"},
        {STRING_FOR_AUX_STAT_YIELDED_NOW, "Yielded now"},
        {STRING_FOR_AUX_STAT_ADVANCE, "Advance x10"},
        {STRING_FOR_AUX_STAT_EMIT, "Emit x10"},
        {STRING_FOR_AUX_STAT_SPI, "SPI status bits"},
        {STRING_FOR_AUX_STAT_LEAD, "Lead now"},
        ...
        {STRING_FOR_SPLIT_KIT, "Split Kit"},
        {STRING_FOR_SPLIT_KIT_DONE, "Kit split"},
        ...
        {STRING_FOR_CLOUDS, "Wisps"},
        {STRING_FOR_CLOUDS_MODE, "Wisps Mode"},
        {STRING_FOR_CLOUDS_MODE_GRANULAR, "Granular"},
        {STRING_FOR_CLOUDS_MODE_STRETCH, "Stretch"},
        {STRING_FOR_CLOUDS_MODE_DELAY, "Delay"},
        {STRING_FOR_CLOUDS_MODE_SPECTRAL, "Spectral"},
        {STRING_FOR_CLOUDS_MODE_OLIVERB, "Oliverb"},
        {STRING_FOR_CLOUDS_MODE_RESONESTOR, "Resonestor"},
        {STRING_FOR_CLOUDS_FREEZE, "Freeze"},
        {STRING_FOR_CLOUDS_POSITION, "Position"},
        {STRING_FOR_CLOUDS_POSITION_SHORT, "Posn"},
        {STRING_FOR_CLOUDS_SIZE, "Size"},
        {STRING_FOR_CLOUDS_SIZE_SHORT, "Size"},
        {STRING_FOR_CLOUDS_PITCH, "Pitch"},
        {STRING_FOR_CLOUDS_PITCH_SHORT, "Ptch"},
        {STRING_FOR_CLOUDS_DENSITY, "Density"},
