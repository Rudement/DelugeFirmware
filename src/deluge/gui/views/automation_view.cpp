...
constexpr int32_t kNumNonGlobalParamsForAutomation = 86; // 83 stock + LOCAL_HEAT + UNPATCHED_MID + UNPATCHED_MID_FREQ
constexpr int32_t kNumGlobalParamsForAutomation = 41;    // 39 stock + UNPATCHED_MID + UNPATCHED_MID_FREQ
