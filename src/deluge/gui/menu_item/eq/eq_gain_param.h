...
/// NOT `final`: see the note on EqFreqParam. rf::Gated<EqGainParam, FourBandEq> derives from
/// this to hide the mid bands when the Four-Band EQ community feature is off.
class EqGainParam : public UnpatchedParam {
public:
