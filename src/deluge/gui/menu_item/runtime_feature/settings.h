...
/// or the std::array ends up with trailing nullptr(s) and scrolling onto one freezes the device. On this line
/// every setting has a top-level menu item -- KeyboardNotePreview included -- so 0.
